...
@Service
public class FinanceTransService {
	@Autowired
	private AssetsFinanceMapper assetsFinanceMapper;
	@Autowired
	...
	public int instock(Assetstrans trans) {
		...
		trans.setBatchno(
	    FinanceTransService.buildBatchNO( assetsFinanceMapper.selectByPrimaryKey(trans.getAssetsid()).getAssetscode()));
